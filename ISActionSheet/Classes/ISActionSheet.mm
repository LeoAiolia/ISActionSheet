...
#define IS_IPHONEX_TABBAR_ADD_HEIGHT        (IS_IPHONE_X ? 34.0 : 0)
#define IS_IPHONE                   (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
#define IS_IPHONE_X                 (IS_SCREEN_WIDTH == 375.0f && IS_SCREEN_HEIGHT == 812.0f && IS_IPHONE)
#define IS_COLOR_RGB(R,G,B)         [UIColor colorWithRed:(R)/255.f green:(G)/255.f blue:(B)/255.f alpha:1.0]
...
- (void)configWeChatStyle
{
    _marginX = 0;
    _marginY = 10;
    _marginBottom = IS_IPHONE_X ? IS_IPHONEX_TABBAR_ADD_HEIGHT: 0;
    _cornerRadius = 0;
...
- (void)configSystemStyle
{
    _marginX = 10;
    _marginY = 10;
    _marginBottom = IS_IPHONE_X ? IS_IPHONEX_TABBAR_ADD_HEIGHT : 10;
    _cornerRadius = 13;
    _actionSheetWidth = IS_SCREEN_WIDTH - 2 * _marginX;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"IS_ACTIONSHEET_CELL"];
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    if (_style == ISActionSheetStyleWeChat) {
        color = IS_COLOR_RGB(240, 240, 240);
    }
